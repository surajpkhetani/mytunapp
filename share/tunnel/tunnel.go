...
//Both mytunapp client and server are Tunnels.
//mytunapp client has a single set of remotes, whereas
//mytunapp server has multiple sets of remotes (one set per client).
